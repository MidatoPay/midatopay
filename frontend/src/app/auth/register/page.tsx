      ...
      >
        {/* Header */}
            ...
            <ArrowLeft className="w-4 h-4" />
                <span style={{ fontFamily: 'Kufam, sans-serif' }}>Back to home</span>
          </Link>
                  ...
                  type="email"
                    ...
                    <div className="space-y-3">
                      ...
                      >
                        ...
                        <span style={{ color: '#2C2C2C' }}>Continue with Google</span>
                      ...
                      >
                        ...
                        <span style={{ color: '#2C2C2C' }}>Continue with Apple</span>
                        <svg className="w-4 h-4 ml-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{ color: '#8B8B8B' }}>
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                        </svg>
                      </button>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <div className="mb-6 space-y-3">
                    <div className="p-3 rounded-lg" style={{ backgroundColor: '#FFF9F5' }}>
                      <p className="text-sm" style={{ color: '#8B8B8B', fontFamily: 'Kufam, sans-serif' }}>Name</p>
