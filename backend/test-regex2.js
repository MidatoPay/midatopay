...
// Probar con regex más específico
console.log('\n--- REGEX MÁS ESPECÍFICO ---');
const specificRegex = /sess_(\d+)_([a-f0-9]+)(?=[A-Z]|$)/i;
const specificMatch = fullQR.match(specificRegex);
if (specificMatch) {
  console.log('Specific Match:', specificMatch[0]);
  console.log('Timestamp:', specificMatch[1]);
  console.log('Hash:', specificMatch[2]);
} else {
